...
import { adminCategoryTrashSchema } from "@/domains/admin/categories/services/admin_category_schemas";
...
export async function POST(
  ...
  const payload = adminCategoryTrashSchema.safeParse({
    categoryId,
  });
  ...
  try {
    ...
    const category = await trashAdminCategory(payload.data.categoryId);
